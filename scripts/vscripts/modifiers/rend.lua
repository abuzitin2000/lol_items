...
function rend:IsHidden()
	return true
end

function rend:IsPurgable()
	return false
end

function rend:RemoveOnDeath()
	return false
end

function rend:OnDestroy()
...
function rend:DeclareFunctions()
    local funcs = {
...
function rend:OnTakeDamageKillCredit( event )
	if not IsServer() then
		return
	end
