item_whiterock = class({})

-- Modifier Linkers
LinkLuaModifier("item_whiterock_modifier", "items/item_whiterock", LUA_MODIFIER_MOTION_NONE)
LinkLuaModifier("support_ward_stack_modifier", "modifiers/support_ward_stack_modifier", LUA_MODIFIER_MOTION_NONE)

function item_whiterock:GetIntrinsicModifierName()
	return "item_whiterock_modifier"
end

function item_whiterock:OnSpellStart()
...
-- Intrinsic Modifier
-------------------------------------------------------------------------------------------------------------
item_whiterock_modifier = class({})

function item_whiterock_modifier:IsHidden()
	return true
end

function item_whiterock_modifier:IsPurgable()
	return false
end

function item_whiterock_modifier:RemoveOnDeath()
	return false
end

function item_whiterock_modifier:GetAttributes()
	return MODIFIER_ATTRIBUTE_MULTIPLE
end

-- Adding Unique Passives
function item_whiterock_modifier:OnCreated()
...
function item_whiterock_modifier:OnDestroy()
	if not IsServer() then
		return
	end
...
-- Stats
function item_whiterock_modifier:DeclareFunctions()
	local funcs = {
...
function item_whiterock_modifier:GetModifierPreAttack_BonusDamage()
	local ability = self:GetAbility()
...
function item_whiterock_modifier:GetModifierHealthBonus()
	local ability = self:GetAbility()
