...
-- Modifier Linkers
LinkLuaModifier("item_true_ice_modifier", "items/item_true_ice", LUA_MODIFIER_MOTION_NONE)
LinkLuaModifier("support_ward_stack_modifier", "modifiers/support_ward_stack_modifier", LUA_MODIFIER_MOTION_NONE)

function item_true_ice:GetIntrinsicModifierName()
	return "item_true_ice_modifier"
end

function item_true_ice:OnSpellStart()
...
-- Intrinsic Modifier
-------------------------------------------------------------------------------------------------------------
item_true_ice_modifier = class({})

function item_true_ice_modifier:IsHidden()
	return true
end

function item_true_ice_modifier:IsPurgable()
	return false
end

function item_true_ice_modifier:RemoveOnDeath()
	return false
end

function item_true_ice_modifier:GetAttributes()
	return MODIFIER_ATTRIBUTE_MULTIPLE
end

-- Adding Unique Passives
function item_true_ice_modifier:OnCreated()
...
function item_true_ice_modifier:OnDestroy()
	if not IsServer() then
		return
	end
...
-- Stats
function item_true_ice_modifier:DeclareFunctions()
	local funcs = {
...
function item_true_ice_modifier:GetModifierHealthBonus()
	local ability = self:GetAbility()
