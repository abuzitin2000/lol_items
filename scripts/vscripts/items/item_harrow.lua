...
-- Modifier Linkers
LinkLuaModifier("item_harrow_modifier", "items/item_harrow", LUA_MODIFIER_MOTION_NONE)
...
function item_harrow:GetIntrinsicModifierName()
	return "item_harrow_modifier"
end

function item_harrow:OnSpellStart()
...
-- Intrinsic Modifier
-------------------------------------------------------------------------------------------------------------
item_harrow_modifier = class({})

function item_harrow_modifier:IsHidden()
	return true
end

function item_harrow_modifier:IsPurgable()
	return false
end

function item_harrow_modifier:RemoveOnDeath()
	return false
end

function item_harrow_modifier:GetAttributes()
	return MODIFIER_ATTRIBUTE_MULTIPLE
end

-- Adding Unique Passives
function item_harrow_modifier:OnCreated()
...
function item_harrow_modifier:OnDestroy()
	if not IsServer() then
		return
	end
...
-- Stats
function item_harrow_modifier:DeclareFunctions()
	local funcs = {
...
function item_harrow_modifier:GetModifierPreAttack_BonusDamage()
	local ability = self:GetAbility()
...
function item_harrow_modifier:GetModifierHealthBonus()
	local ability = self:GetAbility()
