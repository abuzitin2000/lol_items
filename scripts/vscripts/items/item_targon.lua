...
-- Modifier Linkers
LinkLuaModifier("item_targon_modifier", "items/item_targon", LUA_MODIFIER_MOTION_NONE)
...
function item_targon:GetIntrinsicModifierName()
	return "item_targon_modifier"
end

function item_targon:OnSpellStart()
...
-- Intrinsic Modifier
-------------------------------------------------------------------------------------------------------------
item_targon_modifier = class({})

function item_targon_modifier:IsHidden()
	return true
end

function item_targon_modifier:IsPurgable()
	return false
end

function item_targon_modifier:RemoveOnDeath()
	return false
end

function item_targon_modifier:GetAttributes()
	return MODIFIER_ATTRIBUTE_MULTIPLE
end

-- Adding Unique Passives
function item_targon_modifier:OnCreated()
...
function item_targon_modifier:OnDestroy()
	if not IsServer() then
		return
	end
...
-- Stats
function item_targon_modifier:DeclareFunctions()
	local funcs = {
...
function item_targon_modifier:GetModifierHealthBonus()
	local ability = self:GetAbility()
